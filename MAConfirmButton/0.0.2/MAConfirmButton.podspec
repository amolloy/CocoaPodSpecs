Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/amolloy/MAConfirmButton"
  s.license      = 'MIT'
  s.author       = "Mike Ahmarani"
  s.source       = { :git => "https://github.com/amolloy/MAConfirmButton.git", :commit => "5cee904dd7f3b6bab7d9350d83589868297d6475" }
  s.platform     = :ios
